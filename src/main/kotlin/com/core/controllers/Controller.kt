...
import com.core.exceptions.InvalidArguments
...
interface Controller<M> {
    ...
    /**
     * Http router, it receives a class type to return, a request and services to automatically execute and return a response
     * @param cls Class return type
     * @param request Http Client request
     * @param service CRUD services to execute
     */
